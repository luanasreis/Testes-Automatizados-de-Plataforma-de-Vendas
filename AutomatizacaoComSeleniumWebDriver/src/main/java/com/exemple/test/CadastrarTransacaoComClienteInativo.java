...
public class CadastrarTransacaoComClienteInativo {
  ...
  @Test
  public void testCadastrarTransacaoComClienteInativo() throws Exception {
    ...
    new Select(driver.findElement(By.id("cliente"))).selectByVisibleText("Cliente Inativo");
    driver.findElement(By.id("valorTransacao")).sendKeys("3000");
    driver.findElement(By.id("botaoSalvar")).click();
    try {
      assertEquals("Falha na transação. Cliente Inativo.", driver.findElement(By.cssSelector("strong")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
