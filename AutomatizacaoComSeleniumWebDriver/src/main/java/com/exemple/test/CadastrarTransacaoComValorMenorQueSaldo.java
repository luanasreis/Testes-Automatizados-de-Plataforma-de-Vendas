...
public class CadastrarTransacaoComValorMenorQueSaldo {
  ...
  @Test
  public void testCadastrarTransacaoComValorMenorQueSaldo() throws Exception {
    ...
    Thread.sleep(500);
    new Select(driver.findElement(By.id("cliente"))).selectByVisibleText("Cliente com Saldo 200");
