...
import java.util.concurrent.TimeUnit;
	...
	public class CadastrarClienteComNumeroCPFmaior11Digitos {
	  ...
	  @Test
	  public void testCadastrarClienteComNumeroCPFcomValorMaximo() throws Exception {
	    ...
	    driver.findElement(By.id("cpf")).sendKeys("9999999912345678887655443333");
