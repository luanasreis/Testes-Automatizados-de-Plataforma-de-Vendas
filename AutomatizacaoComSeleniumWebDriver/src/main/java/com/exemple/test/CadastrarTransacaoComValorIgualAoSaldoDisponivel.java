...
public class CadastrarTransacaoComValorIgualAoSaldoDisponivel {
  ...
  @Test
  public void testCadastrarTransacaoComValorIgualAoSaldoDisponivel() throws Exception {
    ...
    Thread.sleep(500);
    new Select(driver.findElement(By.id("cliente"))).selectByVisibleText("Cliente com Saldo 300");
    driver.findElement(By.id("valorTransacao")).sendKeys("30000");
    driver.findElement(By.id("botaoSalvar")).click();
    try {
      assertEquals("Venda realizada com sucesso", driver.findElement(By.cssSelector("strong")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
