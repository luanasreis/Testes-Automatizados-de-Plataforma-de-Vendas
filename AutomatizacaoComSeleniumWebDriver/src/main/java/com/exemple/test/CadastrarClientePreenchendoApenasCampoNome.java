...
public class CadastrarClientePreenchendoApenasCampoNome {
  ...
  @Test
  public void testCadastrarClientePreenchendoApenasCampoNome() throws Exception {
    ...
    driver.findElement(By.id("nome")).sendKeys("Teste Cliente");
